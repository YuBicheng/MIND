...
def main(args):
    #version_name = input("input Version name:")+'******\n'
    ...
    trainer = pl.Trainer(accelerator="auto", callbacks=[early_stop_callback, checkpoint_callback], val_check_interval=1.0, max_epochs=100, min_epochs=1, accumulate_grad_batches=args.accumulation, deterministic=True, log_every_n_steps=100)
